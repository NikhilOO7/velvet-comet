...
> Companion docs: full walkthrough in [OVERVIEW.md](OVERVIEW.md), design rationale in [PLAN.md](PLAN.md), the project write-up in [ONE-PAGER.md](ONE-PAGER.md). The customer feedback that prompted it is in [docs/BRIEF.md](docs/BRIEF.md).

---

## The problem it solves

From the loudest, highest-ARR customer in the feedback (competitive-intel platform, $180k, renewal at risk):
...
| temporal | The Coordinator as a Temporal workflow, where durability becomes free (event-sourced) and the loop is just code. |
